...
class colorplot(paperfigure):
    ...
    def __init__(self,x_data,y_data,c_data,
        ...
        for x,y,c in zip(x_data,y_data,c_data):
            ...
            self.ax.scatter(x,y,c=c,cmap=self.cmap,
...
if __name__ == '__main__':
    ...
    if(test_colorplot):
        ...
        cplot_halfcolumn=colorplot(xdata,ydata,cdata,xlabel=r'$x$',ylabel=r'$y$',width_in_cols=0.5)
        cplot_onecolumn=colorplot(xdata,ydata,cdata,xlabel=r'$x$',ylabel=r'$y$',width_in_cols=1)
